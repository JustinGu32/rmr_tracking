...
parser.add_argument("--motion_file", type=str, default='/home/takaraet/Downloads/walk_15s.npz')
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg):
    ...
    print("[INFO] Creating environment (may take 1-2 min)...", flush=True)
    env = gym.make(args_cli.task, cfg=env_cfg, device=device, render_mode=None)
