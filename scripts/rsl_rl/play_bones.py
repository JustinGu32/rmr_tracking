...
parser.add_argument("--popart_group_preset", type=str, default="upper_lower", choices=["upper_lower", "motion_tracking", "actual_individual", "limb_tracking", "limb_tracking_ul", "limb_tracking_ul_individual", "all_rewards"],
