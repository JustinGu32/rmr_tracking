...
mujoco_npz_path = Path("/move/u/karenvo/Projects/rmr_tracking/artifacts/chair_step_tracking_truncated_converted.npz")
out_path = Path("/move/u/karenvo/Projects/rmr_tracking/artifacts/chair_step_tracking_truncated_converted_2.npz")

print("ORIGINAL MUJOCO NPZ FILE")
print("="*80)
mujoco_data = np.load(mujoco_npz_path)
