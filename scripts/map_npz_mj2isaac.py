...
mujoco_npz_path = Path("/move/u/karenvo/Projects/rmr_tracking/artifacts/down_continuous_v2_karen_stairs_mj.npz")
out_path = Path("/move/u/karenvo/Projects/rmr_tracking/artifacts/down_continuous_v2_karen_stairs_mj_2.npz")
