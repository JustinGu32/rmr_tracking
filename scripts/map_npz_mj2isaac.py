...
mujoco_npz_path = Path("/move/u/justingu/whole_body_tracking/motions/chair_step_Skeleton_004.npz")
out_path = Path("/move/u/justingu/whole_body_tracking/motions/chair_step.npz")
