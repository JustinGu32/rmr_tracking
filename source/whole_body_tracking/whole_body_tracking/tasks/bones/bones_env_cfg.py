...
ROUGH_TERRAINS_CFG = TerrainGeneratorCfg(
    ...
    sub_terrains={
        ...
        "boxes": terrain_gen.MeshRandomGridTerrainCfg(
            proportion=0.2, grid_width=0.45, grid_height_range=(0.001, 0.005), platform_width=2.0
        ),
        "random_rough": terrain_gen.HfRandomUniformTerrainCfg(
            proportion=0.2, noise_range=(0.001, 0.005), noise_step=0.02, border_width=0.25
        ),
...
@configclass
class BonesEnvCfg(ManagerBasedRLEnvCfg):
