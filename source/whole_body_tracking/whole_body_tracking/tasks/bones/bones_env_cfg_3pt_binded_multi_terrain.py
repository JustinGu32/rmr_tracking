...
from whole_body_tracking.tasks.bones.terrain_mesh_spawner_cfg import FLAT_PLANE_MARKER, MultiTerrainMeshSpawnerCfg
...
@configclass
class Bones3ptBindedMultiTerrainEnvCfg(ManagerBasedRLEnvCfg):
