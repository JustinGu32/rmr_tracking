...
@configclass
class CommandsCfg:
    """Command specifications for the MDP (binded: each env bound to a motion via env_id % num_motions)."""
...
@configclass
class Tracking3ptBindedEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the 3pt tracking environment with binded motion (env_id % num_motions per env)."""
